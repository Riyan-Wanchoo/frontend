                            ...
                            return (
                                <div key={item.attributes.slug} className="xl:w-1/4 md:w-1/2 p-4">
                                    <div className="bg-gray-100 p-6 rounded-lg">
                                        <img className="h-96 rounded mb-8 m-auto" src={item.attributes.image.data && item.attributes.image.data.attributes.name} alt="content" />
                                        ...
                                        <div className="hidden bg-red-800 bg-blue-800 bg-green-800 bg-yellow-800 bg-black bg-white"></div>
